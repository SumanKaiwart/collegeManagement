...
<body>  
	...
	<div class="formbox">
		...
		<tr>
		<td>First Name : </td>
		<td><input type="text" placeholder = "First Name" name="fname" value="<?php echo $name;?>"><span class="error">* <?php echo $nameErr;?></span></td>
		<td>Last Name :</td>
		<td><input type="text" placeholder = "Last Name" name="lname" value="<?php echo $lname;?>">
